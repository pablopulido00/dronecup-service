...
public class StandingUpdateRequest {
    ...
    public StandingUpdateRequest() {
    }

    public StandingUpdateRequest(Integer points, Long championshipId, Long pilotId) {
        this.points = points;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StandingUpdateRequest that)) return false;
