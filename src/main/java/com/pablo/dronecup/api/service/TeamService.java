...
public class TeamService {
    ...
    public List<TeamResponse> getAllTeams(){
        ...
        public TeamResponse updateTeam(Long id, TeamUpdateRequest request) {
            ...
            return new TeamResponse(
                    updatedTeam.getId(), updatedTeam.getName(), updatedTeam.getCountry(),
        ...
        public void deleteTeam (Long id){
            ...
            if (!team.getPilots().isEmpty()){
                throw new RuntimeException("No se puede borrrar un equipo con pilotos");
